        ...
        <div className='max-w-lg mx-auto shadow px-6 py-7 rounded overflow-hidden'>
          ...
          <form action='#' method='post' autoComplete='off'>
            ...
            <div className='mt-4'>
              <button
                type='submit'
                className='block w-full py-2 text-center text-blue bg-primary border border-primary rounded hover:bg-transparent hover:text-primary transition uppercase font-roboto font-medium'
              >
                Login
              </button>
            </div>
